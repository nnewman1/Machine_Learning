# Python tutorial using scikit-learn with AdaBoost ensemble classification on the pima indians diabetes dataset.
...
theModel = AdaBoostClassifier(n_estimators=num_trees, random_state=theSeed)
